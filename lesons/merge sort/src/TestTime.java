...
//лучше ли использовать в любом случае мердж сорт, так как он будет выполняться на сервере и в
// ремя выполнения не повлияет на отображение для конечного пользователя?
